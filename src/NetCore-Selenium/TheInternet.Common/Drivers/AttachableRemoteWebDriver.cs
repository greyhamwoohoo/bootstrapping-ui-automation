...
namespace TheInternet.Common.WebDrivers
{
    ...
    {
        const string BROWSER_NAME = "REMOTE";
        ...
        {
            var remoteServerUriField = this.CommandExecutor.GetType().GetField("remoteServerUri", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var remoteServerUri = remoteServerUriField.GetValue(this.CommandExecutor);
        ...
        {
            var remoteServerUriField = this.CommandExecutor.GetType().GetField("remoteServerUri", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            remoteServerUriField.SetValue(this.CommandExecutor, new Uri(value));
        }

        private CommandInfoRepository GetCommandInfoRepository()
        {
            var commandInfoRepositoryField = this.CommandExecutor.GetType().GetField("commandInfoRepository", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            var commandInfoRepository = commandInfoRepositoryField.GetValue(this.CommandExecutor);
        ...
        {
            var commandInfoRepositoryField = this.CommandExecutor.GetType().GetField("commandInfoRepository", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            commandInfoRepositoryField.SetValue(this.CommandExecutor, repository);
        }
    }
}
