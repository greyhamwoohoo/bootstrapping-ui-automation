...
namespace TheInternet.Common.SessionManagement.Contracts
{
    ...
    {
        IBrowserSession Create(IBrowserProperties properties, RemoteWebDriverSettings remoteWebDriverSettings, EnvironmentSettings environmentSettings, IControlSettings controlSettings);
    }
}
