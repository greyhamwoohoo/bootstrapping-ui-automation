...
namespace TheInternet.Common.SessionManagement.Contracts
{
    public interface IDriverSessionFactory
    {
        ...
        IDriverSession Create(IDeviceProperties deviceProperties, IBrowserProperties properties, RemoteWebDriverSettings remoteWebDriverSettings, EnvironmentSettings environmentSettings, IControlSettings controlSettings, ILogger logger, ITestCaseReporter testCaseReporter);
    }
}
